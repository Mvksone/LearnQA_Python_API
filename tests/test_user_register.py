...
@allure.epic("Register users cases")
class TestUserRegister(BaseCase):
    ...
    @allure.title("Test for successful user creation")
    ...
    @allure.description("Test for creating a user with an existing email")
    ...
    @allure.description("Test for creating a user with an incorrect email")
    ...
    def test_create_user_without_any_param(self, condition):
        with allure.step(f"Test data without '{condition}'"):
    ...
    @allure.description("Test for creating a user with short email")
    ...
    @allure.description("Test for creating a user with long email")
