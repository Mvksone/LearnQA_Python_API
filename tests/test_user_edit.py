...
class TestUserEdit(BaseCase):
    ...
    @allure.story("Story: edit a new user with auth as another user")
    def test_edit_new_user_with_auth_another_user(self):
         ...
         with allure.step("Registration user 2"):
             register_data =self.prepare_registration_data()
         ...
         with allure.step("Edit user 2 with user 1 data"):
             new_name = "Changed Name"
         ...
         with allure.step("Get and assert user 2 data"):
    ...
    @allure.story("Story: test edit wrong email with auth the same user")
    def test_edit_wrong_email_with_auth_same_user(self):
        ...
        with allure.step("Edit user 1 with wrong email"):
    ...
    @allure.story("Story: test edit wrong firstName with auth the same user")
    def test_edit_wrong_firstName_with_auth_same_user(self):
        ...
        with allure.step("Edit user with wrong short firstName"):
            new_name = "a"
            response3 = MyRequests.put(
                f"/user/{user_id}",
                headers={"x-csrf-token": token},
